...
import { SelectItem, SharedModule} from 'primeng/primeng';
import { DomHandler } from './domhandler';
import {NG_VALUE_ACCESSOR, ControlValueAccessor} from '@angular/forms';

export const DROPDOWN_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => Dropdown2),
  multi: true
};

@Component({
    selector: 'p-dropdown2',
    template: `
...
export class Dropdown2 implements OnInit,AfterViewInit,AfterViewChecked,DoCheck,OnDestroy,ControlValueAccessor {
